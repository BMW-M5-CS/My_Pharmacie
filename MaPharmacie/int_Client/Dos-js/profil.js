...
btnAnnulerInfos.addEventListener("click", function() {
    ...
    document.getElementById('edit-email-recuperation').value       = (document.getElementById('lecture-email-recuperation').textContent.trim() === 'Non renseigné') ? '' : document.getElementById('lecture-email-recuperation').textContent.trim();
    document.getElementById('edit-telephone-recuperation').value   = document.getElementById('lecture-telephone-recuperation').textContent.trim().startsWith('Non renseigné') ? '' : document.getElementById('lecture-telephone-recuperation').textContent.trim();
...
btnEnregistrerInfo.addEventListener("click", function() {
    ...
    const emailRecuperation     = document.getElementById('edit-email-recuperation').value.trim();
    const telephoneRecuperation = document.getElementById('edit-telephone-recuperation').value.trim();
...
modaleConfirmer.addEventListener('click', function() {
    ...
    fetch('../Dos-php/traite_profil.php', {
        ...
        body: JSON.stringify({
            ...
            email_recuperation:        emailRecuperation,
            telephone_recuperation:    telephoneRecuperation,
    ...
    .then(function(data) {
        ...
        if (data.success) {
            ...
            document.getElementById('lecture-email-recuperation').textContent       = data.email_recuperation || 'Non renseigné';
            document.getElementById('lecture-telephone-recuperation').textContent   = data.telephone_recuperation || 'Non renseigné (SMS bientôt disponible)';
