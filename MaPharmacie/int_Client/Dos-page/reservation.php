...
<body data-id-pharmacie="<?php echo (int)$pharmacie['id_pharmacie']; ?>"
    ...
    <div class="resa-confirm-overlay" id="resa-confirm-overlay">
        <div class="resa-confirm-box">
            ...
            <p id="resa-confirm-message">
                Votre demande a été transmise à la pharmacie. Vous recevrez un email dès qu'elle sera acceptée,
                avec votre code de retrait. Vous pouvez aussi suivre son statut dans "Mes réservations".
            </p>
