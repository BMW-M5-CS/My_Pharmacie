...
$sql  = "SELECT nom, prenom, phone_email, email_recuperation, telephone_recuperation, assurance_defaut FROM users WHERE id_user = ?";
...
$email_recuperation     = $user['email_recuperation']     ?? '';
$telephone_recuperation = $user['telephone_recuperation'] ?? '';
    ...
    <div class="profil-contenu">
        ...
        <div class="profil-section">
            ...
            <div class="profil-champs-lecture" id="infos-lecture">
                ...
                <div class="profil-champ-ligne">
                    <span class="profil-champ-label">Email de récupération</span>
                    <span class="profil-champ-valeur" id="lecture-email-recuperation">
                        <?php echo htmlspecialchars($email_recuperation ?: 'Non renseigné'); ?>
                    </span>
                </div>

                <div class="profil-champ-ligne">
                    <span class="profil-champ-label">Téléphone de récupération</span>
                    <span class="profil-champ-valeur" id="lecture-telephone-recuperation">
                        <?php echo htmlspecialchars($telephone_recuperation ?: 'Non renseigné (SMS bientôt disponible)'); ?>
                    </span>
                </div>
            ...
            <div class="profil-champs-edition" id="infos-edition" style="display: none;">
                ...
                <div class="profil-input-groupe">
                    <label>Email de récupération <span class="profil-optionnel">(optionnel)</span></label>
                    <input
                        type="email"
                        id="edit-email-recuperation"
                        value="<?php echo htmlspecialchars($email_recuperation); ?>"
                        placeholder="Une adresse email pour récupérer votre compte si besoin">
                </div>

                <div class="profil-input-groupe">
                    <label>Téléphone de récupération <span class="profil-optionnel">(optionnel — pour bientôt, SMS pas encore actif)</span></label>
                    <input
                        type="tel"
                        id="edit-telephone-recuperation"
                        value="<?php echo htmlspecialchars($telephone_recuperation); ?>"
