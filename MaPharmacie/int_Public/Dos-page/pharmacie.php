...
$sql_villes = "SELECT DISTINCT ville FROM pharmacies WHERE statut = 'active' ORDER BY ville ASC";
...
<head>
    ...
    <title>Nos pharmacies — MaPharmacie</title>
