...
<head>
    ...
    <title>Mot de passe oublié — MaPharmacie</title>
    ...
    <div class="boite-centrale">
        ...
        <?php else : ?>
            ...
            <form action="../Dos-php/traite_mdp_oublie.php" method="POST">
                ...
                <div class="groupe-champ">
                    <label>Comment souhaitez-vous recevoir le lien ?</label>
                    <div class="choix-canal">
                        <label class="canal-option canal-actif">
                            <input type="radio" name="canal" value="email" checked>
                            <i class="fa-solid fa-envelope"></i> Par email
                        </label>
                        <label class="canal-option canal-desactive" title="Bientôt disponible">
                            <input type="radio" name="canal" value="sms" disabled>
                            <i class="fa-solid fa-comment-sms"></i> Par SMS
                            <span class="canal-bientot">Bientôt disponible</span>
                        </label>
                    </div>
                </div>
